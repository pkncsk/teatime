...
import pandas as pd
#%%
the1c_patched = pd.read_csv('/home/pc575/rds/rds-kzfps-XrHDlpCeVDg/users/pakkanan/dev/teatime/debug/te_age_ltr_patch/the1c_age_bandaid_fix.txt', sep='\t', index_col =0)
#%%
df=the1c_patched
#%%
import pandas as pd
