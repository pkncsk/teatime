...
internal_id_dir = '/home/pc575/rds/rds-kzfps-XrHDlpCeVDg/users/pakkanan/dev/teatime/debug/pyvolve-test/simTHE1C'
e_table_dir = '/home/pc575/rds/rds-kzfps-XrHDlpCeVDg/users/pakkanan/dev/teatime/debug/pyvolve-test/simTHE1C'
age_table_dir = '/home/pc575/rds/rds-kzfps-XrHDlpCeVDg/users/pakkanan/dev/teatime/debug/pyvolve-test/simTHE1C'
#%%
...
def filter_e2(e_table,
    ...
    #test second pass
        ...
        if second_pass_tbl.shape[0] > 1:
            ...
            spliced_maf_age=spliced_maf_full.merge(divergence_table[['meta_name','ungapped_length','divergenc']], how='left',on='meta_name')
