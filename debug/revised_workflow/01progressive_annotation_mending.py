...
import re
#%% INPUT PARAMETERS
output_dir = '/home/pc575/rds/rds-kzfps-XrHDlpCeVDg/users/pakkanan/data/output/teatime447/internal_id/' 
...
subfam_target=repname_counts['repName']
#subfam_target=repname_counts[repname_counts['count'] < 100000]['repName']
#subfam_target=repname_counts[(repname_counts['count'] >= 1000) & (repname_counts['count'] < 5000)]['repName']
subfamilies = subfam_target
#%%
