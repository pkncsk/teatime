...
age_table_dir = '/home/pc575/rds/rds-kzfps-XrHDlpCeVDg/users/pakkanan/dev/teatime/debug/revised_workflow/'
#%% function load
...
filtered_group=idtc_table
#filter for extremes
Q1 = filtered_group['te_age'].quantile(0.1)
Q3 = filtered_group['te_age'].quantile(0.9)
IQR = Q3 - Q1
lower_bound = Q1 - 1.5 * IQR
upper_bound = Q3 + 1.5 * IQR

outliers = filtered_group[(filtered_group['te_age'] == 0) | (filtered_group['te_age'] > upper_bound)]
outliers
"""
NOTE: intermidiate result:
69 outliers from 9789 entries
2 entries with 69.0
67 entries with 0.0
"""
#%% coordinate prep
...
outlier_list=outliers['internal_id'].unique()

for internal_id in outlier_list:
    print(internal_id)
    outliers_subset= outliers[outliers['internal_id']==internal_id]
    ...
    #plt.tight_layout()
    #plt.show()
    image_filepath = f'/home/pc575/rds/rds-kzfps-XrHDlpCeVDg/users/pakkanan/dev/teatime/debug/revised_workflow/outliers_investigation/outlier_age{te_age}_{chrom}_{maf_min}-{maf_max}.jpeg'
