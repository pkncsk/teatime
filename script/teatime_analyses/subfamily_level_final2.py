...
ax.set_title(f"{class_of_interest} counts grouped by TEATIME and Kimura distance derived age", fontdict={'fontsize':10})
...
ax.set_xlabel("TEATIME age (MYA)")
ax.set_ylabel("estimated age from kimuradistance (MYA)")
ax.set_title(f"Per column Z-scores of {class_of_interest} count grouped by TEATIME and Kimura distance derived age", fontdict={'fontsize':10})
...
ax.set_xlabel("TEATIME age (MYA)")
ax.set_ylabel("Estimated age from kimuradistance (MYA)")
ax.set_title(f"Fraction of {class_of_interest} grouped by TEATIME and Kimura distance derived age", fontdict={'fontsize':10})
