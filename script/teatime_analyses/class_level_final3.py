...
ax.set_title(f"{class_of_interest} TE counts grouped by TEATIME and Kimura distance derived age", fontdict={'fontsize':10})

# 🔹 Step 7: Add gridlines to match custom bin sizes
ax.grid(True, which="both", color="white", linestyle="-", linewidth=0.5, alpha=0.5)
fig.patch.set_facecolor("white")
plt.savefig(f"./fig/{class_of_interest_filename}_te_heatmap.png", dpi=300, bbox_inches="tight")
plt.show()
...
ax.set_xlabel("TEATIME age (MYA)")
ax.set_ylabel("estimated age from kimuradistance (MYA)")
ax.set_title(f"Per column Z-scores of {class_of_interest} TE count grouped by TEATIME and Kimura distance derived age", fontdict={'fontsize':10})

# 🔹 Step 7: Add gridlines to match custom bin sizes
ax.grid(True, which="both", color="white", linestyle="-", linewidth=0.5, alpha=0.5)
fig.patch.set_facecolor("white")
plt.savefig(f"./fig/{class_of_interest_filename}_te_heatmap_z.png", dpi=300, bbox_inches="tight")
plt.show()
#%%
#calculate fraction
...
ax.set_xlabel("TEATIME age (MYA)")
ax.set_ylabel("Estimated age from kimuradistance (MYA)")
ax.set_title(f"Fraction of {class_of_interest} TE grouped by TEATIME and Kimura distance derived age", fontdict={'fontsize':10})

# 🔹 Step 7: Add gridlines to match custom bin sizes
ax.grid(True, which="both", color="white", linestyle="-", linewidth=0.5, alpha=0.5)
fig.patch.set_facecolor("white")
plt.savefig(f"./fig/{class_of_interest_filename}_te_heatmap_f.png", dpi=300, bbox_inches="tight")
plt.show()
# %%
import numpy as np
import pandas as pd
...
ax.set_xlabel("TEATIME age (MYA)")
ax.set_ylabel("estimated age from kimuradistance (MYA)")
ax.set_title(f"Per column fractions of {class_of_interest} TE count grouped by TEATIME and Kimura distance derived age", fontdict={'fontsize':10})

# 🔹 Step 7: Add gridlines to match custom bin sizes
ax.grid(True, which="both", color="white", linestyle="-", linewidth=0.5, alpha=0.5)
fig.patch.set_facecolor("white")
plt.savefig(f"./fig/{class_of_interest_filename}_te_heatmap_z2.png", dpi=300, bbox_inches="tight")
plt.show()
#%%