...
internal_id_dir = '/home/pc575/rds/rds-kzfps-XrHDlpCeVDg/users/pakkanan/data/output/teatime447/internal_id/'
...
subfamily_list = None
#====== OUTPUT DIRECTORY ================
e_table_dir = '/home/pc575/rds/rds-kzfps-XrHDlpCeVDg/users/pakkanan/data/output/teatime447/e_value/'



#subfamily_list = subfam_target
...
def main(internal_id_dir, 
    ...
    for subfam in subfamily_list:
        e_val_calc_batch(subfam, internal_id_dir, e_table_dir,maf_dir, target_species,extension_length,e_value_cutoff)
#%%
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Testing sequence similarity in multispecies alignment with BLAST-like algorithm")
    ...
    parser.add_argument('-d', '--internal_id_dir', required=True,
        help="Directory containing internal ID tables from the previous step")
    ...
    parser.add_argument('-o', '--output', required=True,
        help="Output directory for E-value tables")
    ...
    parser.add_argument('-e', '--e_value_cutoff', type=float, default=1e-3,
        help="E-value cutoff threshold for filtering (default: 1e-3)")
